                ...
                <table class="logintable" border="2">
                    ...
                    <%
                        try
                        {
                            ...
                            String query="SELECT user_email, user_firstname, user_surname, user_hometown FROM users WHERE user_email = 'test@test.com'";
                    ...
                    %>
                    <h3>Hello <%=rs.getString("user_firstname") %>!</h3>
